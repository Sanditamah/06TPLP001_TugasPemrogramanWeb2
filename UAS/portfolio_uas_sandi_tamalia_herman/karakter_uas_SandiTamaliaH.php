<!--//Nama File 				: karakter_uas_SandiTamaliaH.php
...
<body>
    ...
    <div class="section-mb-10">
        <div class="container">
            <h3>Data Karakter</h3>
            <div class="box">
                <button type="button" class="btn btn-sm btn-dark mb-3" data-bs-toggle="modal" data-bs-target="#tambah_karakter">
                    <i class="fas fa-plus fa-sm"></i> Tambah Karakter
                </button>
                <table border="1" cellspacing="0" class="table">
                    ...
                    <tbody>
                        <?php
                        $no = 1;
                        $karakter = mysqli_query($conn, "SELECT * FROM karakter ORDER BY id");
                        while ($row = mysqli_fetch_array($karakter)) {
                        ?>
                            <tr align="center">
                                <td><?php echo $no++ ?></td>
                                <td><?php echo $row['karakter'] ?></td>
                                <td>
                                    <a href="edit_karakter_uas_SandiTamaliaH.php?id=<?php echo $row['id'] ?>">
                                        <div class="btn btn-primary btn-sm"><i class="fa fa-edit"></i></div>
                                    </a> &nbsp;
                                    <a href="hapus_uas_SandiTamaliaH.php?idk=<?php echo $row['id'] ?>" onclick="return confirm('Yakin ingin hapus ?')">
    ...
    <!-- Modal -->
    <div class="modal fade" id="tambah_karakter" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="exampleModalLabel">Tambah Karakter</h5>
