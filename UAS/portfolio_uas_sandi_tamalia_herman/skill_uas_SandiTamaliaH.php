<!--//Nama File 				: skill_uas_SandiTamaliaH.php
...
<body>
    ...
    <div class="section-mb-10">
        <div class="container">
            <h3>Data Skill</h3>
            <div class="box">
                <button type="button" class="btn btn-sm btn-dark mb-3" data-bs-toggle="modal" data-bs-target="#tambah_skill">
                    <i class="fas fa-plus fa-sm"></i> Tambah Skill
                </button>
                <table border="1" cellspacing="0" class="table">
                    ...
                    <tbody>
                        <?php
                        $no = 1;
                        $skill = mysqli_query($conn, "SELECT * FROM skill ORDER BY id");
                        ...
                        ?>
                            <tr align="center">
                                ...
                                <td>
                                    <a href="edit_skill_uas_SandiTamaliaH.php?id=<?php echo $row['id'] ?>">
                                        <div class="btn btn-primary btn-sm"><i class="fa fa-edit"></i></div>
                                    </a> &nbsp;
                                    <a href="hapus_uas_SandiTamaliaH.php?ids=<?php echo $row['id'] ?>" onclick="return confirm('Yakin ingin hapus ?')">
            ...
            <div class="modal-content">
                ...
                <form action="tambah_uas_SandiTamaliaH.php" method="post">
                    ...
                    <div class="modal-footer">
                        <button type="submit" class="btn btn-primary" name="submitsk">Simpan</button>
