<!--//Nama File 				: edit_pendidikan_uas_SandiTamaliaH.php
...
$pendidikan = mysqli_query($conn, " SELECT * FROM pendidikan WHERE id = '" . $_GET['id'] . "' ");
if (mysqli_num_rows($pendidikan) == 0) {
    echo '<script>window.location="edit_pendidikan_uas_SandiTamaliaH.php"</script>';
}
$pend = mysqli_fetch_object($pendidikan);
?>
        ...
        <div class="container_style">
            <div class="box">
                ...
                <form action="" method="POST">
                    <input type="text" name="pendidikan" class="input-control" placeholder="Pendidikan" value="<?php echo $pend->pendidikan ?>" required>
                    <input type="text" name="tahun" class="input-control" placeholder="Tahun" value="<?php echo $pend->tahun ?>" required>
                ...
                if (isset($_POST['submit'])) {
                    ...
                    $update = mysqli_query($conn, " UPDATE pendidikan SET 
